...
def load_data(data_dir: str,
    ...
    # Convert _to numpy
    train_df = train_df.map(_convert_sample, size, gray_scale).batch(batch_size)
    val_df = val_df.map(_convert_sample, size, gray_scale).batch(batch_size)
    test_df = test_df.map(_convert_sample, size, gray_scale).batch(batch_size)        
